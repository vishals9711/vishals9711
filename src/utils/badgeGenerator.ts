...
export function generateCountBadge(label: string, count: number, color = '#007acc'): string {
  return generateBadge({
    label,
...
export function generatePercentageBadge(language: string, percentage: string): string {
  return generateBadge({
    label: language,
    message: `${percentage}%`,
    color: '#007acc',
